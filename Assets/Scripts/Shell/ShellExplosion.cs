...
public class ShellExplosion : MonoBehaviour
{
    ...
    private void Vibrate()
    {
        ...
        {
            int ApiLevel = androidVersionClass.GetStatic<int>("SDK_INT");
            Debug.Log(ApiLevel);
        ...
        using (AndroidJavaObject currentActivity = unityPlayer.GetStatic<AndroidJavaObject>("currentActivity"))
        {
            if (currentActivity != null)
            {
                ...
                parameters[0] = milliseconds;
                parameters[1] = amplitude;
                using (AndroidJavaObject effect = vibrationEffectClass.CallStatic<AndroidJavaObject>("createOneShot", parameters))
                {
